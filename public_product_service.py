...
LEGAL_CONTENT = {
"ru": {
"privacy": {"title":"Политика конфиденциальности","lead":"Документ описывает обработку данных при использовании публичного сайта и сервиса Spyon.","sections":[
