      ...
      "sections": [
        {
          ...
          "items": [
            ...
            "Для площадок, брендов, статусов, размеров и других характеристик можно выбрать несколько значений одновременно.",
      ...
      "sections": [
        {
          ...
          "items": [
            ...
            "Для Ozon используйте подготовленный браузерный профиль: Chrome должен быть открыт, а профиль — доступен сборщику.",
    ...
    "reports": {
      ...
      "sections": [
        ...
        },
        {
          "title": "Экспорт",
          "items": [
            "Площадки, бренды, размеры и остальные характеристики можно комбинировать в одном отчёте.",
            "Таблица внизу страницы показывает первые позиции выбранной выборки.",
            "Кнопка «Сформировать Excel» создаёт файл XLSX; CSV, JSON и HTML сохраняются для совместимости и интеграций."
          ]
        }
      ],
      ...
      "sections": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Браузерный профиль должен быть доступен; при работе с Ozon не закрывайте подготовленное окно Chrome до завершения операции.",
      ...
      "sections": [
        {
          ...
          "items": [
            ...
            "Арналар, брендтер, мәртебелер, өлшемдер және басқа сипаттамалар бойынша бірнеше мәнді қатар таңдауға болады.",
      ...
      "sections": [
        {
          ...
          "items": [
            ...
            "Ozon үшін дайындалған браузер профилін пайдаланыңыз: Chrome ашық болып, профиль жинаушыға қолжетімді болуы керек.",
    ...
    "reports": {
      ...
      "sections": [
        ...
        },
        {
          "title": "Экспорт",
          "items": [
            "Арналарды, брендтерді, өлшемдерді және басқа сипаттамаларды бір есепте біріктіруге болады.",
            "Беттің төменгі жағындағы кесте таңдалған деректердің алғашқы позицияларын көрсетеді.",
            "«Excel жасау» батырмасы XLSX файлын жасайды; CSV, JSON және HTML үйлесімділік пен интеграциялар үшін сақталады."
          ]
        }
      ],
      ...
      "sections": [
        ...
        },
        {
          ...
          "items": [
            ...
            "Браузер профилі қолжетімді болуы керек; Ozon жұмыс істеп тұрған кезде дайындалған Chrome терезесін операция аяқталғанша жаппаңыз.",
      ...
      "sections": [
        {
          ...
          "items": [
            ...
            "You can select multiple marketplaces, brands, statuses, sizes and other characteristics at the same time.",
      ...
      "sections": [
        {
          ...
          "items": [
            ...
            "For Ozon, use the prepared browser profile: Chrome must remain open and the profile must be available to the collector.",
    ...
    "reports": {
      ...
      "sections": [
        ...
        },
        {
          "title": "Export",
          "items": [
            "Marketplaces, brands, sizes and other characteristics can be combined in one report.",
            "The table at the bottom previews the first products in the selected dataset.",
            "Generate Excel creates an XLSX file; CSV, JSON and HTML remain available for compatibility and integrations."
          ]
        }
      ],
